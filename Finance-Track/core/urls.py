...
urlpatterns = [
    ...
    path('transactions/bulk-import/', views.bulk_import_transactions, name='bulk_import_transactions'),
    path('transactions/download-template/', views.download_template, name='download_template'),
